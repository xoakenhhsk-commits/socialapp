    ...
    try {
      if (mediaFile) {
        ...
        if (!mediaFile.type.startsWith('image/')) {
          alert("Chỉ hỗ trợ tải lên hình ảnh qua dịch vụ ImgBB.");
        ...
        // Fake progress for UI since fetch doesn't support upload progress easily
      ...
      alert("Failed to create post. Check ImgBB API Key.");
    } finally {
      setIsUploading(false);
    }
  };
